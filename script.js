...
function normalizeUser(user) {
  ...
  const walletChartEnabled = normalizedRole === 'member'
    ? (typeof source.walletChartEnabled === 'boolean' ? source.walletChartEnabled : shouldDefaultWalletChartEnabled(normalizedUsername))
    : false;
...
function normalizeSettings(rawSettings) {
  ...
  return {
    ...
    passwordSeed1705Done: Boolean(source.passwordSeed1705Done),
